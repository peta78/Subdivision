...
This works on [Ubuntu](https://ubuntu.com/) and arch linux as well, after installing [GPU drivers](https://wiki.archlinux.org/title/GPGPU) (for AMD do 'sudo pacman -S rocm-opencl-runtime'). 
