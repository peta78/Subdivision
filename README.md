...
This works on [Linux Mint](https://linuxmint.com/), [Ubuntu](https://ubuntu.com/), [Sparky Linux](https://sparkylinux.org/) and [arch linux](https://archlinux.org/) (for example Manjaro) as well, after installing [GPU drivers](https://wiki.archlinux.org/title/GPGPU) (for AMD do 'sudo pacman -S rocm-opencl-runtime'). 
